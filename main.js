...
var root = from_html(`<nav aria-label="Sidebar navigation"><div class="brand svelte-1b12cm3"><div class="logo svelte-1b12cm3">\u2713</div> <div><strong class="svelte-1b12cm3">Todo Dashboard</strong> <small class="svelte-1b12cm3">Vault-backed task board</small></div></div> <div class="pinned-nav svelte-1b12cm3"><button type="button">\u{1F4CC} Uncategorized / Group-level</button> <button type="button">\u{1F3E1} Dashboard</button></div> <div class="group-list svelte-1b12cm3"><!> <!></div></nav>`);
var $$css = {
  hash: "svelte-1b12cm3",
